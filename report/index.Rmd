...
is_to_update <- getOption("tipnet.auto_update", TRUE) &&
  is_expired(last_file, getOption("tipnet.max_days_update"))

if (getOption("tipnet.force_update") || is_to_update) {
...
output$report <- downloadHandler(
  ...
  content = function(file) {
    ...
    rmarkdown::render(report, "html_document", file, params = params,
      runtime = "static", envir = new.env(parent = globalenv())
    )
  }
)
```
